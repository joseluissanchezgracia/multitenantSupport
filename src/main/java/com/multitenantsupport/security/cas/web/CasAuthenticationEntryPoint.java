 ...
 * - Metodo createRedirectUrl se modifica para obtener una URL multitenant apropiada en caso de ser necesario
 * 
...
public class CasAuthenticationEntryPoint implements AuthenticationEntryPoint, InitializingBean {
   ...
   protected String createRedirectUrl(final String serviceUrl) {
   	...
   	String redirectUrl = CommonUtils.constructRedirectUrl(this.loginUrl, this.serviceProperties.getServiceParameter(), serviceUrl, this.serviceProperties.isSendRenew(), false);
   	String multitenantRedirectUrl = new MultitenantContextProvider().getMultitenantUrlFromUrl(redirectUrl);
   	return multitenantRedirectUrl;
   }
   ...
   public final IServiceProperties getServiceProperties() {
   ...
   public final void setServiceProperties(final IServiceProperties serviceProperties) {
